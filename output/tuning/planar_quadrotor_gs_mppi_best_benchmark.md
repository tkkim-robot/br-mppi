# Best Benchmark: planar_quadrotor / gs_mppi

- Study: `planar_quadrotor_gs_mppi`
- Best trial: `14`
- Best objective: `0.739313`
- Benchmark trials: `100`
- JSON: `output/tuning/planar_quadrotor_gs_mppi_best_benchmark.json`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| planar_quadrotor | gs_mppi | 100 | 74 | 14 | 12 | 0 | 0.740 | 0.140 | 213.0 | 43.36 | -0.118 |
...
```json
{
  ...
  "gs_softmin_rho": 10.0,
  "gs_closed_form_gamma": 6.0,
  "gs_alpha": 4.0,
  "gs_composite_margin": 0.3,
  "plot_samples": 0
}
```
