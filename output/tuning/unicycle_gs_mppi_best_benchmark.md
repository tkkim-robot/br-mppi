# Best Benchmark: unicycle / gs_mppi

- Study: `unicycle_gs_mppi`
- Best trial: `0`
- Best objective: `0.638236`
- Benchmark trials: `100`
- JSON: `output/tuning/unicycle_gs_mppi_best_benchmark.json`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| unicycle | gs_mppi | 100 | 64 | 36 | 0 | 0 | 0.640 | 0.360 | 129.3 | 34.65 | -0.096 |
...
```json
{
  ...
  "gs_softmin_rho": 40.0,
  "gs_closed_form_gamma": 3.8000000000000003,
  "gs_alpha": 3.2,
  "gs_composite_margin": 0.2,
  "plot_samples": 0
}
```
