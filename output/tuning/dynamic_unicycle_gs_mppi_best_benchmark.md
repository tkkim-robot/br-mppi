# Best Benchmark: dynamic_unicycle / gs_mppi

- Study: `dynamic_unicycle_gs_mppi`
- Best trial: `11`
- Best objective: `0.688481`
- Benchmark trials: `100`
- JSON: `output/tuning/dynamic_unicycle_gs_mppi_best_benchmark.json`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| dynamic_unicycle | gs_mppi | 100 | 69 | 31 | 0 | 0 | 0.690 | 0.310 | 49.9 | 45.20 | -0.457 |
...
```json
{
  ...
  "gs_softmin_rho": 5.0,
  "gs_closed_form_gamma": 2.2,
  "gs_alpha": 0.7000000000000002,
