# Best Benchmark: planar_quadrotor / shield_mppi

- Study: `planar_quadrotor_shield_mppi`
- Best trial: `16`
- Best objective: `0.749802`
- Benchmark trials: `100`
- JSON: `output/tuning/planar_quadrotor_shield_mppi_best_benchmark.json`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| planar_quadrotor | shield_mppi | 100 | 75 | 4 | 21 | 0 | 0.750 | 0.040 | 316.6 | 50.99 | -0.130 |
...
```json
{
  ...
  "shield_cbf_penalty_weight": 3000.0,
  "shield_alpha": 0.8,
  "shield_repair_horizon": 4,
  "shield_repair_steps": 8,
  "shield_repair_step_size": 0.15,
