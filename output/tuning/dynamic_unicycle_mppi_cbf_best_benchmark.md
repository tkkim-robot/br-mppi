# Best Benchmark: dynamic_unicycle / mppi_cbf

- Study: `dynamic_unicycle_mppi_cbf`
- Best trial: `8`
- Best objective: `0.719166`
- Benchmark trials: `100`
- JSON: `output/tuning/dynamic_unicycle_mppi_cbf_best_benchmark.json`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| dynamic_unicycle | mppi_cbf | 100 | 72 | 17 | 11 | 7 | 0.720 | 0.170 | 168.9 | 36.74 | -0.064 |
...
```json
{
  ...
  "cbf_alpha": 0.8,
  "cbf_qp_iterations": 20,
  "cbf_qp_rho": 4.0,
  "cbf_qp_regularization": 1e-07,
