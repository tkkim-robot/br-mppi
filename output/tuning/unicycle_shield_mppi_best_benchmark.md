# Best Benchmark: unicycle / shield_mppi

- Study: `unicycle_shield_mppi`
- Best trial: `13`
- Best objective: `0.639703`
- Benchmark trials: `100`
- JSON: `output/tuning/unicycle_shield_mppi_best_benchmark.json`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| unicycle | shield_mppi | 100 | 64 | 6 | 30 | 4 | 0.640 | 0.060 | 406.2 | 38.75 | -0.075 |
...
```json
{
  ...
  "shield_repair_steps": 4,
  "shield_repair_step_size": 0.03,
