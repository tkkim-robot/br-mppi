# Best Benchmark: unicycle / sc_mppi

- Study: `unicycle_sc_mppi`
- Best trial: `0`
- Best objective: `0.169943`
- Benchmark trials: `100`
- JSON: `output/tuning/unicycle_sc_mppi_best_benchmark.json`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| unicycle | sc_mppi | 100 | 17 | 1 | 82 | 0 | 0.170 | 0.010 | 849.2 | 92.14 | -0.121 |
...
```json
{
  ...
  "sc_barrier_eps": 0.01,
  "sc_barrier_gamma": 0.35000000000000003,
  "sc_feedback_gain": 0.08,
  "sc_feedback_clip": 1.3,
  "sc_feedback_iterations": 1,
  "sc_feedback_regularization": 0.01,
  "sc_beta_cost_weight": 3.0,
  "sc_state_cost_weight": 0.02,
  "sc_control_cost_weight": 0.15,
